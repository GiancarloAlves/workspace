function validateForm(form) {
  ...
  function validarEmissao() {
    var filtroNF = form.getValue("devNF");
    if (filtroNF == "" || filtroNF == null) {
      throw "Preencha o campo FILTRO NF!";
    }

    var valorNF = form.getValue("valorNF");
    if (valorNF == "" || valorNF == null) {
      throw "Preencha o campo Valor da nota!";
    }
  }
