...
function deployFollow() {
    ...
    var c1 = DatasetFactory.createConstraint('A06_MATRICULA', MATRICULA, MATRICULA, ConstraintType.MUST);
    ...
    for (var i=0;i<dataset.values.length;i++){
        wdkAddChild('TabelaTitulos');
        // newId -> sequência do Pai x Filho que retorna dessa função wdkAddChild
        // $("#codprod___"+newId).val(dataset.values[i].A08_CODPROD);
