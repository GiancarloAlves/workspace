...
function deployNota(){
   ...
   const NF = document.getElementById('filtroNF').value;
    ...
    var c1 = DatasetFactory.createConstraint('NUMNOTA', NF, NF, ConstraintType.MUST);
    var constraints = new Array (c1)

    var dataset = DatasetFactory.getDataset("ds_produtos_nf_saida_winthor", null, constraints, null);
    console.log(dataset)
    ...
    for (var i=0;i<dataset.values.length;i++){
        ...
        $("#pedidoEspecial___"+newId).val(converterProduto(dataset.values[i].DEVOLUCAO));
