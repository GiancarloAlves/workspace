...
function somar40Dias() {
  ...
  var novaData45 = new Date(data.getTime() + (20 * 24 * 60 * 60 * 1000)); // Soma 20 dias à data
...
function setSelectedZoomItem(selectedItem) {
  ...
  switch (inputId) {
    ...
    case `matricula`:
      ...
      // Converte timestamp para data no formato dd/mm/yyyy
      $(`#datainicio`).val(moment(selectedItem.A05_DT_ADMISSAO).format("DD/MM/YYYY"))
