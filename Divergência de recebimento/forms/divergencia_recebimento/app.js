...
function taskHandler() {
  ...
  switch (TASK) {
    ...
    case COMPRADOR_RESPONSAVEL:
      updateLED("led_acaoCompras", true);
      recolherOutrosPaineis("#acaoCompras");
      break;

    case ACAO_RECEBIMENTO:
      updateLED("led_acaoRecebimento", true);
      recolherOutrosPaineis("#acaoRecebimento");
      break;

    case FOLLOWUP:
      updateLED("led_followup", true);
      recolherOutrosPaineis("#followup");
      break;

    case ACAO_NO_ESTOQUE:
      updateLED("led_acaoNoEstoque", true);
      recolherOutrosPaineis("#acaoNoEstoque");
      break;
  }
}
...
function dadosDevolucao() {
  const acaoComprador = $("#acaoComprador").val();

  if (acaoComprador === "Devolução") {
    $(".dadosDev").removeClass("hidden");
  } else {
    $(".dadosDev").addClass("hidden");
  }
}
