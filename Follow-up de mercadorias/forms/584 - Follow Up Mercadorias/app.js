...
function deployFollow() {
    ...
    var dataset = DatasetFactory.getDataset("ds_oc_follow_winthor", null, constraints, null);
...
function enableMainOC() {
    var mainOC = document.getElementById("mainOC");
    mainOC.disabled = false;
}

function enablePesqprod() {
    var pesqcod = document.getElementById("pesqcod");
    pesqcod.disabled = false;
}

function enableBotaoOC() {
    $('#listaitem').attr('hidden', false);
}

function enableBotaoItem() {
    $('#listaoc').attr('hidden', false);
}

function enableBotaoDeploy() {
    $('#deploylista').attr('hidden', false);
}

function enableGeral() {
    enableBotaoItem()
    enableBotaoOC()
    enableBotaoDeploy()
}
