function inputFields(form){
	...
	toBrazilianFormmat(form, "date_inicioatividade");
	toBrazilianFormmat(form, "date_terminoatividade");
	toBrazilianFormmat(form, "date_reprogramacao");
	toBrazilianFormmat(form, "data_finalizacao");
