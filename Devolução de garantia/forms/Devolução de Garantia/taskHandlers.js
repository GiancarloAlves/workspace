...
function taskHandlerAprovacaoSupervisor() {
    ...
    setTimeout(() => {
        ...
        // Aciona o select para habilitar ou desebalitar o campo aprovar solicitação - Não é necessário na devolução de garantia
...
// function taskHandlerAjustarDevolucao() { //NÃO PRECISA NA GARANTIA
...
// function taskHandlerAlteracaoCobranca() { //NÃO PRECISA NA GARANTIA
